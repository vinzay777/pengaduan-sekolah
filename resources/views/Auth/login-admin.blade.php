        ...
        <div class="w-full md:w-1/2 px-5 py-8 sm:px-6 sm:py-10 md:p-8 lg:p-10 flex flex-col justify-center">
            ...
            <div class="max-w-md mx-auto w-full">
                ...
                <p class="text-gray-600 text-center md:text-left mb-6 text-sm">
                    Masukkan username dan password untuk mengelola pengaduan
                </p>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                placeholder="admin"
                                value="{{ old('username') }}"
                                class="w-full pl-11 pr-4 py-3 border-2 @error('username') border-red-500 @else border-gray-300 @enderror rounded-xl focus:outline-none focus:border-orange-500 transition-colors"
                                required
                            >
                        </div>
                        @error('username')
